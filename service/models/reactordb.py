...
class Reactor(dataobj.DataObj, ReactorDAO):
    def __init__(self, raw=None):
            ...
            "structs" : {
                "reactor" : {
                    "fields" : {
                        ...
                        "comment_1" : {"coerce" : "unicode", "ignore_none" : True},
                        "comment_2" : {"coerce" : "unicode", "ignore_none" : True},
                        "comment_3" : {"coerce" : "unicode", "ignore_none" : True},
                        ...
                        "licensed_to" : {"coerce" : "unicode", "ignore_none" : True},
                        ...
                        "planned_closure" : {"coerce" : "unicode", "ignore_none" : True},
                        "planned_start_up" : {"coerce" : "unicode", "ignore_none" : True},
        ...
        properties = {
            ...
            "comment_1" : ("reactor.comment_1", None),
            "comment_2" : ("reactor.comment_2", None),
            "comment_3" : ("reactor.comment_3", None),
            ...
            "licensed_to" : ("reactor.licensed_to", None),
            ...
            "planned_closure" : ("reactor.planned_closure", None),
            "planned_start_up" : ("reactor.planned_start_up", None),
